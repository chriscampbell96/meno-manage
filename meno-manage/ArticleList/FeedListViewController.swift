...
class FeedListViewController: UITableViewController, XMLParserDelegate {
    ...
    override func viewDidLoad() {
        ...
        tableView.backgroundColor = UIColorFromRGB(rgbValue: 0xfffffff)
...
//    http://feeds.skynews.com/feeds/rss/technology.xml
    ...
    //working feeds
        //http://www.menopausepro.com/menopauseblog/feed
    
    func loadData() {
        url = URL(string: "http://www.menopausepro.com/menopauseblog/feed")!
        loadRss(url);
    }
